...
<div class="main-container ace-save-state" id="main-container">
    ...
    <div id="sidebar" class="sidebar responsive-min ace-save-state compact" data-sidebar="true"
            ...
            <li class="">
                    <span class="">
                        <a href="" data-target=".actualizar_logomarca{{Auth::user()->id}}" data-toggle="modal">
                            <img class="nav-user-photo" src="{{ url('/upload/'.$empresa->logotipo)}}"
                                 style="max-width: 100%; border-radius: 100px; height: 72px; width: 75px; left: 14px; position: sticky"/>
                        </a>
                    </span>
            </li>
...
{{--            </li>--}}
            ...
            <li class="hover">
                ...
                <ul class="submenu">
                    ...
                    <li class="hover">
                        <a href="{{ route('sequenciaDocumento.index')}}">
                            <i class="menu-icon fa fa-list" style="color: white;"></i>
...
{{--                    </li>--}}
            ...
            <li class="">
                <a href="{{route('relatorio.relatoriosGeral')}}">
                    <i class="menu-icon fa fa-file-pdf-o"></i>
                    <span class="menu-text">RELATORIOS GERAIS</span>
                </a>
            </li>
            ...
            <div class="modal-dialog modal-lg" style="width: 400px">
                <div class="modal-content">
                    <div class="modal-header text-center red" id="logomarca-header">
                        ...
                        <h4 class="smaller white"><i class="ace-icon fa fa-pencil bigger-150 white"></i> Alterar
                            Logomarca</h4>
                    </div>
                            ...
                            <div class="">
                                <div id="" class="row">
                                    <div class="col-sm-offset-1 col-sm-10">
                                        <form method='post'
                                              action='{{url('/empresa/update_logomarca')}}/{{$empresa->id}}'
                                            ...
                                            <div id="user-profile-" class="user-profile row">
                                                                ...
                                                                <div class="col-md-11">
                                                                    <div class="file-upload-wrapper">
                                                                        <input type="file" name="logotipo"
                                                                               accept="image/*" id="id-input-file-4"
                                                ...
                                                <div class="clearfix form-actions">
                                                    <div class="col-md-offset-1 col-md-10">
                                                        &nbsp; &nbsp;
                                                        <button class="btn btn-success bigger-150" id="logomarca-butom"
                                                                type="submit" style="border-radius: 14px;">
...
<style type="text/css">
    ...
    .texto-personalizado {
        ...
        color: blue; /* Definir a cor do texto como azul */
    }
