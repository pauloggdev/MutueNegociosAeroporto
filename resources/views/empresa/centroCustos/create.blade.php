                        ...
                        <div class="tab-content profile-edit-tab-content">
                            ...
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select wire:model="centroCusto.statusId" class="col-md-12 select2" id="status" style="height:35px;<?= $errors->has('centroCusto.status_id') ? 'border-color: #ff9292;' : '' ?>">
                            ...
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                ...
                                <div class="col-md-4">
                                    <label class="control-label bold label-select2" for="newAlvara">Alvará</label>
                                    <div class="input-group">
                                ...
                                <div class="col-md-4">
                                    <label class="control-label bold label-select2" for="newNIF">NIF</label>
                                    <div class="input-group">
