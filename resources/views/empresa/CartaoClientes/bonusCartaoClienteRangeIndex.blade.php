...
<div class="row">
                                    ...
                                    <div class="tabbable">
                                        <div class="tab-content profile-edit-tab-content">
                                            <div id="dados_motivo" class="tab-pane in active">
                                                @foreach($rangesBonus as $bonu)
                                                    <div class="form-group has-info">
                                                        <div class="col-md-4">
                                                            <label class="control-label bold label-select2"
                                                                   for="sequencia">Intervalo inicial<b
                                                                    class="red fa fa-question-circle"></b></label>
                                                            <div>
                                                                <input type="number" value="{{ $bonu['min'] }}"
                                                                       id="sequencia"
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="control-label bold label-select2"
                                                                   for="sequencia">Intervalo final<b
                                                                    class="red fa fa-question-circle"></b></label>
                                                            <div>
                                                                <input type="number" value="{{ $bonu['max'] }}"
                                                                       id="sequencia"
                                                                       class="col-md-12 col-xs-12 col-sm-4"/>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <label class="control-label bold label-select2"
                                                                   for="sequencia">Valor Bônus<b
                                                                    class="red fa fa-question-circle"></b></label>
                                                            <div>
                                                                <input type="number" value="{{ $bonu['valor'] }}"
                                                                       id="sequencia"
                                                                       class="col-md-12 col-xs-12 col-sm-4"/>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="clearfix form-actions">
                                            <div class="col-md-9">
                                                <button class="search-btn" style="border-radius: 10px"
                                                        wire:click.prevent="atualizarBonusRangeCartaoCliente">

                                                    <span wire:loading.remove wire:target="atualizarBonusRangeCartaoCliente">
                                                        <i class="ace-icon fa fa-print bigger-110"></i>
                                                        SALVAR
                                                    </span>
                                                    <span wire:loading wire:target="atualizarBonusRangeCartaoCliente">
    ...
    <div class="page-header" style="left: 0.5%; position: relative">
        <h1>
            INTERVALO BÔNUS(%) CARTÃO CLIENTES
            <small>
                    ...
                    <div class="col-xs-12 widget-box widget-color-green" style="left: 0%">
                        <div class="clearfix">
                            @if(count($bonusCartaoCliente) <= 0)
                                <a href="#modalEditarBonus" data-toggle="modal" wire:click="modalAddBonus"
                                   title="emitir novo recibo" class="btn btn-success widget-box widget-color-blue"
                                   id="botoes">
                                    ...
                                    <tr>
                                        ...
                                        <td style="text-align: center">
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a href="#modalEditarBonus" data-toggle="modal"
                                                   wire:click="modalEditaBonus({{ json_encode($bonuCliente) }})"
                                                   class="pink" title="Editar o bonus da compra"
