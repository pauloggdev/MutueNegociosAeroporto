                ...
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-12" style="z-index: 1">
                            ...
                            <select wire:model="produtoSelecionado" data="produtoSelecionado"
                                    class="col-md-12 select2">
                                <option>SELECIONA O PRODUTO</option>
                                @foreach($produtos as $produto)
                                    <option
                                        value="{{ json_encode($produto) }}">{{ Str::upper($produto['nomeProduto']) }}
                                        - {{isset($produto['codigoProduto'])?$produto['codigoProduto']:null}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @if(count($fatura['items']) > 0)
                            <tr>
                                ...
                                <th style="width: 10%;text-align:right;">PREÇO IVA</th>
                                <th style="text-align:right; width: 15%">PREÇO UNIT.</th>
                                <th></th>
                            </tr>
                        @endif
                        </thead>
                        ...
                        @foreach($fatura['items'] as $produto)
                            <tr style="display: table; width: 100%; table-layout: fixed"
                                ...
                                <td style="width: 60%"> {{ str::limit(Str::upper($produto['nomeProduto']), 50) }}
                                    <b>({{ number_format($produto['quantidade'],1, ',', '.') }})</b> <br/>
                                </td>
                                <td style="text-align: right; width: 10%">
                                    <span>{{ number_format($produto['iva'], 2, ',', '.') }}</span>
                                </td>
