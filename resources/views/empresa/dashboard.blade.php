...
@section('content')
    ...
    @if(Auth::user()->hasRole('Super-Admin') || !Auth::user()->hasPermissionDashboard('Sem acesso a dashboard'))
    ...
    @endif
    @if(Auth::user()->hasPermissionDashboard('Sem acesso a dashboard') && !Auth::user()->hasRole('Super-Admin'))
