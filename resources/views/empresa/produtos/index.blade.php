                    ...
                    <div class="row">
                        <div class>
                            <div class="input-group input-group-sm" style="margin-bottom: 10px">
                                ...
                                <input type="text" wire:model.debounce.1000ms="filter.search" autofocus autocomplete="on" class="form-control search-query" placeholder="Buscar nome do produto" />
                        ...
                        <div class="col-xs-12 widget-box widget-color-green" style="left: 0%">
                            <div class="clearfix" style="display: flex;padding: 5px 5px; align-items: center">
                                ...
                                <div class="input-group input-group-sm" style="margin-left: 10px; width: 180px" >
                                    <select wire:model="filter.vendasOnline" data="vendasOnline" class="col-md-12 select2">
                                ...
                                <div class="input-group input-group-sm" style="margin-left: 10px; width: 300px" >
                                    <select wire:model="filter.centroCustoId"data="centroCustoId" class="col-md-12 select2">
                                        @foreach($centrosCusto as $centroCusto)
                                            <option value="{{ $centroCusto->id }}" <?= $filter['centroCustoId'] == $centroCusto->id ?'selected':'' ?>>{{ Str::title($centroCusto->nome) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
