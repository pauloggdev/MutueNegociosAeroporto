                        ...
                        <div class="tab-content profile-edit-tab-content">
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select wire:model="comuna.provinciaId" data="provinciaId" class="col-md-12 select2"
                                            style="height:35px;<?= $errors->has('comuna.provinciaId') ? 'border-color: #ff9292;' : '' ?>">
                                        @foreach($provincias as $provincia)
                                            <option value="{{ $provincia->id }}" <?= $provincia->id == $comuna['provinciaId']?'selected':''?>>{{ Str::upper($provincia->designacao) }}</option>
                                        @endforeach
                                ...
                                <div class="col-md-4">
                                    <label class="control-label bold label-select2">Munícipio</label>
                                    <select wire:model="comuna.municipioId" data="municipioId" class="col-md-12 select2"
                                            style="height:35px;<?= $errors->has('comuna.municipioId') ? 'border-color: #ff9292;' : '' ?>">
                                        <option value="">Selecione o munícipio</option>
                                    @foreach($municipios as $municipio)
                                            <option value="{{ $municipio->id }}" <?= $municipio->id == $comuna['municipioId']?'selected':''?>>{{ Str::upper($municipio->designacao) }}</option>
                                        @endforeach
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="text" wire:model="comuna.designacao" class="form-control"
                                               ...
                                               style="height: 35px; font-size: 10pt;<?= $errors->has('comuna.designacao') ? 'border-color: #ff9292;' : '' ?>"/>
                            ...
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        <input type="number" wire:model="comuna.valorEntrega" class="form-control"
                                               ...
                                               style="height: 35px; font-size: 10pt;<?= $errors->has('comuna.valorEntrega') ? 'border-color: #ff9292;' : '' ?>"/>
                                        <span class="input-group-addon" id="basic-addon1">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select wire:model="comuna.statusId" data="statusId"
                                            ...
                                            id="statusId"
                                            style="height:35px;<?= $errors->has('comuna.statusId') ? 'border-color: #ff9292;' : '' ?>">
                                        <option value="1" <?= $comuna['statusId'] == 1?'selected':''?>>ATIVO</option>
                                        <option value="2"  <?= $comuna['statusId'] == 2?'selected':''?>>DESATIVO</option>
