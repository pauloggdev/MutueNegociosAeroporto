                            ...
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                <div class="col-md-6">
                                    ...
                                    <div wire:ignore>
                                        ...
                                        <select wire:model="destaque.produtoId" data="produtoId" id="produtoId" class="col-md-12 select2" style="height:35px;<?= $errors->has('destaque.produtoId') ? 'border-color: #ff9292;' : '' ?>">
                                            <option value="">Selecione...</option>
                                            @foreach($produtos as $produto)
                                            <option value="{{ $produto->id }}">{{ \Illuminate\Support\Str::title($produto->designacao) }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <label class="control-label bold label-select2" for="designacao">Titulo<b class="red fa fa-question-circle"></b></label>
