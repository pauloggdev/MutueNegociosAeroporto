                ...
                <div class="second-row">
                    ...
                    <div class="tabbable">
                        <div class="tab-content profile-edit-tab-content">
                            ...
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                <div class="col-md-12">
                                    <label class="control-label bold label-select2" for="nomeCliente">Imagem (jpeg, png, jpg)<b
                                            class="red fa fa-question-circle"></b></label>
                                    <div class="input-group">
                                        <input type="file" wire:model="imagens" class="form-control"
                    ...
                    <div class="clearfix form-actions">
                        <div class="col-md-offset-3 col-md-9">
                            <button class="search-btn" type="submit" style="border-radius: 10px"
                                    wire:click.prevent="salvarNovoBanner">
                                <span wire:loading.remove wire:target="salvarNovoBanner">
                                    <i class="ace-icon fa fa-check bigger-110"></i>
                                    Salvar
                                </span>
                                <span wire:loading wire:target="salvarNovoBanner">
