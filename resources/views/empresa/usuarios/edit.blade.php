                        ...
                        <div class="tab-content profile-edit-tab-content">
                            ...
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                <div class="col-md-6">
                                    ...
                                    <select wire:model="user.status_id" class="col-md-12" id="status_id" style="height:35px;<?= $errors->has('user.status_id') ? 'border-color: #ff9292;' : '' ?>">
                            ...
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                <div class="col-md-12" style="left: 0%; position: relative">
                                    <label class="control-label bold label-select2" for="">Selecione a função do usuario<b class="red fa fa-question-circle"></b></label>
                                    <select class="col-md-12" multiple id="selectMultiplo2">
                                        @foreach ($roles as $roleBancao)
                                            <option value="{{$roleBancao->id}}" @if(in_array($roleBancao['id'],$selectedPerfils )) selected @endif>{{ $roleBancao->designacao }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
