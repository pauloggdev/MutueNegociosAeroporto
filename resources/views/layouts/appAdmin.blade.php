            ...
            <ul class="nav nav-list">
                ...
                <li class="hover">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="hover">
                            <a href="{{ route('admin.users.funcao') }}">
                                <i class="menu-icon fa fa-caret-right"></i>
                                FUNÇÃO
                            </a>
                            <b class="arrow"></b>
                        ...
                        <li class="hover">
                            <a href="{{ route('admin.users.permissao') }}">
                                <i class="menu-icon fa fa-caret-right"></i>
                                PERMISSÃO
                            </a>
                            <b class="arrow"></b>
...
{{--                </li>--}}
                ...
                <li class="">
                        <a href="{{route('pagamentoLicencasIndex')}}">
                        <i class="menu-icon fa fa-list-alt"></i>
                            <span class="menu-text"> PAGAMENTOS DE LICENÇAS </span>
                        </a>
                        <b class="arrow"></b>
                    </li>
                    <!-- <li class="">
                        <a href="{{route('notificacaoDeAvisoIndex')}}">
                        <i class="menu-icon fa fa-list-alt"></i>
                            <span class="menu-text"> NOTIFICAÇÕES DE AVISO </span>
                        </a>
                        <b class="arrow"></b>
                    </li> -->
                <li class="hover">
    ...
    <!-- Ckeditor -->
    <script src="https://cdn.tiny.cloud/1/wjaee7ffm4ihrmleku03567uluavg9xxc4dudr9w690fblq5/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
        <script>
    ...
    tinymce.init({
        ...
        language: 'pt_BR', // Definindo o idioma para Português do Brasil
        ...
        setup: function (editor) {
            ...
            editor.on('blur', function (e) {
                ...
                livewire.emit('selectedContentTinymce', editor.getContent())
            });
            // window.addEventListener('load-tinymce', function (event) {
            //     console.log(event.detail.body);
            // });
        },

    });
    window.livewire.on('initTinymce',()=>{
    ...
    <script type="text/javascript">
           window.addEventListener('mostrarImagemComprovativo', event => {
            var data = event.detail.data;
            let img = document.getElementById("imgComprovativo");
