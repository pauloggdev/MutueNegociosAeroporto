                        ...
                        <div class="tab-content profile-edit-tab-content">
                            ...
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select wire:model="utilizador.status_id" class="col-md-12" id="status_id" style="height:35px;<?= $errors->has('utilizador.status_id') ? 'border-color: #ff9292;' : '' ?>">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group">
                                        <input type="file" wire:model="utilizador.foto" class="form-control" id="foto"
                            ...
                            <div class="form-group has-info bold" style="left: 0%; position: relative">
                                <div class="col-md-4">
                                    <label class="control-label bold label-select2" for="perfil_id">Perfil</label>
                                    <select wire:model="utilizador.role_id" class="col-md-12" id="status_id"
                                            style="height:35px;<?= $errors->has('utilizador.status_id') ? 'border-color: #ff9292;' : '' ?>">
                                        <option value="">Selecione um perfil</option>
                                    @foreach($perfis as $p)
                                            <option value="{{ $p->id }}">{{ $p->designacao }}</option>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('utilizador.role_id'))
                                        <span class="help-block" style="color: red; font-weight: bold">
                                        <strong>{{ $errors->first('utilizador.role_id') }}</strong>
                                    </span>
                                    @endif
                                </div>
                            </div>
                    ...
                    <div class="clearfix form-actions">
                        <div class="col-md-offset-3 col-md-9">
                            <button class="search-btn" type="submit" style="border-radius: 10px"
                                    wire:click.prevent="salvarUtilizador">
