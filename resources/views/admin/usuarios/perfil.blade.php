                    ...
                    <div class>
                        <div class="input-group input-group-sm" style="margin-bottom: 10px">
                            ...
                            <input type="text" wire:model="search" autofocus autocomplete="on"
                                   class="form-control search-query" placeholder="Buscar pelo nome"/>
            ...
            <div class="row">
                <form id="adimitirCandidatos" method="POST" action>
                    ...
                    <div class="col-xs-12 widget-box widget-color-green" style="left: 0%">
                        <div class="clearfix">
                            <a href="{{ route('adminUserPerfilNovo') }}" title="emitir novo recibo"
                               class="btn btn-success widget-box widget-color-blue" id="botoes">
                                <i class="fa icofont-plus-circle"></i> Novo perfil
                            </a>
                            <a title="Lista de bancos" wire:click.prevent="imprimirUtilizadores" target="blank"
                                ...
                                @foreach($perfis as $key=> $p)
                                    <tr>
                                        ...
                                        <td class="hidden-480" style="text-align: center">
                                            <span
                                                class="label label-sm <?= $p['statuGeral']['id'] == 1 ? 'label-success' : 'label-warning' ?>"
                                                style="border-radius: 20px;">{{ $p['statuGeral']['designacao'] }}</span>
                                        </td>
                                        <td>
                                            <div class="hidden-sm hidden-xs action-buttons">
                                                <a href="{{ route('adminRoleUpdate', $p->uuid) }}" class="pink"
                                                   title="Editar este registo">
                                                    <i class="ace-icon fa fa-pencil bigger-150 bolder success text-success"></i>
                                                </a>
                                                <a href="{{ route('AdminRolesPermissao', $p->uuid) }}"
