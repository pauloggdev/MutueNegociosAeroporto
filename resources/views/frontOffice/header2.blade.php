            ...
            <div class="container-fluid">
                {{-- <div class="header-top row align-items-center">
                    <div class="col-lg-3">
                        <div class="brand">
                            <a href="/">
                                <img src="{{asset('assets/frontOffice/img/logoNovo.png')}}" class="img-fluid" alt=""  style="width: 500000px; height: auto;">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-9">
                        ...
                        <div class="navbar navbar-expand-lg bg-light navbar-light">
                            ...
                            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                                <div class="navbar-nav ml-auto">
                                    ...
                                    <a href="{{ \Illuminate\Support\Facades\Storage::url("../upload/manualUtilizador.pdf") }}" download class="btn btn-primary">
