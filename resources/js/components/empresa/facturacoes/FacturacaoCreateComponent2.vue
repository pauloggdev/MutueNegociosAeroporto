    ...
    <div class="facturaRegibo">
        <div class="">
            ...
            <div class="row" id="content-facturacao">
                <div class="col-md-4 grid-facturacao" id="produto-item">
                    ...
                    <div id="info-total">
                        <div>
                            ...
                            <div class="total-item">
                                DESCONTO <span>{{ 1000 | currency }}</span>
                            </div>
                            <div class="total-item">
                                TOTAL DA FATURA
                            ...
                            <div class="total-item">
                                TOTAL IVA <span>{{ 1000 | currency }}</span>
                            </div>
                            <div class="total-item">
                                TOTAL RETENÇÃO
                                <span>{{ 1000 | currency }}</span>
                ...
                <div class="col-md-5">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <Select2 :options="optionsArmazens">
                            </Select2>
                        </div>
                                ...
                                <div class="col-md-12">
                                    <span class="input-form-icon">
                                        <form action id="search-form">
                                            <input type="text" class="col-md-12 search-query"
                                                placeholder="Buscar produtos e serviços..." autocomplete="off"
                                                v-model="queryProduto" autofocus />
                        ...
                        <div class="col-md-12" v-if="!resultQueryProduto.length" style="margin-top: 10px">
                            <div id="semProduto">
                    ...
                    <div class="row" style="overflow-y: scroll; height: 620px">
                        <div class="col-md-4 content-produto" v-for="(prod, i) in resultQueryProduto" :key="i"
                            @onmousemove="popUp">
                            <abbr v-if="prod.categoria_id != 1" :title="prod.categoria.toUpperCase()">
                                <div class="
                    ...
                    " style="heigth: 100px" id="widget-box-6">
                                    ...
                                    <div class="widget-body produto-info produtoItem" @dblclick="adicionarProduto(prod)">
                                        <div class="widget-main padding-6">
                                            <div class="alert alert-info">
                                                {{ prod.designacao.toUpperCase() }} <br />
                                                <span v-if="prod.stocavel == 'Sim'" style="text-align-right"
                                                    class="badge badge-danger">stock: {{ prod.quantidade | formatQt }}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="col-md-3">
                    <div class="row">
                        <PesquisarCliente :guard="guard" @onAddCliente="adicionarCliente"></PesquisarCliente>
                    </div>
                    <div class="row">
                    ...
                    " id="myTab4">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 inputFormPag">
                                                ...
                                                <div class="inputFormPag">
                                                    <Select2 :options="optionsFormaPagamentos"
                                                        @select="selecionarFormaPagamento" id="disabled-pagamento"
                                                        v-model.number="facturacao.formas_pagamento_id">
                                                    </Select2>
                                                    <a v-if="guard.tipo_user_id == 2" href="#criar_formapagamento"
                                                        title="Adicionar formas de Pagamento" data-toggle="modal"
                                                        class="pull-right" style="margin-top: -27px; position: relative">
                                                        <i class="
                                  fa
                                  icofont-plus-circle
                                  bigger-150
                                ...
                                " style="color: #337ab7"></i>
                                                ...
                                                <div class="inputFormPag">
                                                    ...
                                                    <input type="number" v-model="valorEntregue" id="disabled-valor_pagar"
                                                        class="form-control" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 inputFormPag">
                                                <div class="inputFormPag">
                                                    ...
                                                    <input type="number" v-model.number="descontoTotal" :max="descontomax"
                                                        :min="1" class="form-control" />
                                                </div>
                                                <div class="checkbox">
                                                    <label class="block">
                                                        <input v-model="checkRetencao" name="form-field-checkbox"
                            ...
                            " id="myTab4">
                                                ...
                                                <div class="tab-content">
                                                    <div id="dropdown17" class="tab-pane in active">
                                                        <div class="radio">
                                                            <label>
                                                                <input name="form-field-radio1" v-model="checkTipoDocumento"
                                                                    :value="1" type="radio" class="ace input-sm" />
                                                                <span class="lbl bigger-100">FT.RECIBO</span>
                                                            </label>
                                                            <label>
                                                                <input name="form-field-radio2" v-model="checkTipoDocumento"
                                                                    :value="2" type="radio" class="ace input-sm" />
                                                                <span class="lbl bigger-100">FATURA</span>
                                                            </label>

                                                            <label>
                                                                <input name="form-field-radio3" v-model="checkTipoDocumento"
                                                                    :value="3" type="radio" class="ace input-sm" />
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="form-check" style="float: left">
                                                                        <label class="form-check-label">
                                                                            <input class="form-check-input"
                                                                                ...
                                                                                @change="alterarFolha(1)" :checked="impressao.vida == 1 ? true : false
                                                                    ...
                                                                    <div class="form-check" style="float: left">
                                                                        <label class="form-check-label">
                                                                            <input class="form-check-input"
                                                                                :value="facturacao.tipoFolha"
                                                                                @change="alterarFolha(2)" :checked="impressao.vida == 2 ? true : false
                                                                                    " type="radio" name="radio1" />
                                                                            A5
                                                                        </label>
                                                                    </div>
                                                                    <div class="form-check" style="float: left">
                                                                        <label class="form-check-label">
                                                                            <input class="form-check-input"
                                                                                :value="facturacao.tipoFolha"
                                                                                @change="alterarFolha(3)" :checked="impressao.vida == 3 ? true : false
                                                                                    " type="radio" name="radio1" />
                                                                            TICKET
                                                                        </label>
                                                                    </div>
                            ...
                            " id="myTab4">
                                                    <li class="active">
                                                        <a data-toggle="tab" href="#clienteDiverso1">CLIENTE-GERAL</a>
                                                    </li>

                                                    <li>
                                                        <a data-toggle="tab" href="#clienteDiverso2">CLIENTE-OUTRO</a>
                                                    </li>
                                                </ul>
                                                <div class="tab-content">
                                        ...
                                        "></i>
                                                                ...
                                                                <input type="text" v-model="facturacao.cliente.nif_cliente"
                                                                    class="form-control" />
                                                            </div>
                                                            <div class="col-md-12 inputFormPag">
                                                                <label class="control-label bold" for="preco_compra">
                                        ...
                                        "></i>
                                                                ...
                                                                <input type="text" v-model="facturacao.cliente.telefone_cliente
                                                                    " class="form-control" />
                                                            </div>
                                        ...
                                        "></i>
                                                                ...
                                                                <input type="text" v-model="facturacao.cliente.endereco_cliente
                                                                    " class="form-control" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div id="clienteDiverso2" class="tab-pane">
                                                        ...
                                                        <i class="fa fa-question-circle bold text-danger"></i>
                                                                ...
                                                                <input autocomplete="true" type="text" v-model="facturacao.cliente.conta_corrente_cliente
                                                                    " class="form-control" />
                                                            </div>
                                                            <div class="col-md-12 inputFormPag">
                                                                <label class="control-label bold" for="preco_compra">
        ...
        <div class="row">
            <div class="" style="float: right; padding-right: 10px; margin-right: 10px">
                ...
                <a href="#" id="btnFacturacao" class="btn btn-app btn-primary btn-xs" @click.prevent="cadastrarFactura"
                    ...
                    <div class="form-group">
                        <div class="col-md-12" style="margin-bottom: 5px">
                            ...
                            <div class="input-icon">
                                <input type="number" min="1" v-model.number="produto.quantidade_produto" autocomplete="off"
                                    style="height: 35px" class="col-md-12" />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-md-6">
                            ...
                            <div class="input-icon">
                                <input disabled type="number" min="0" v-model.number="produto.descontoAnterior"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-icon">
                                <input autofocus type="number" min="0" v-model.number="produto.desconto_produto"
                                    class="col-md-12 col-xs-12 col-sm-4" />
                                <i class="ace-icon fa fa-percent"></i>
                            </div>
                        </div>
                  ...
                  >
                    ...
                    <div class="form-group">
                        <div class="col-md-12" style="margin-top: 10px">
                            <button class="btn btn-sm btn-success pull-left" @click.prevent="EditItemProduto"
                                data-dismiss="modal">
                        ...
                        <div class="row" style="left: 0%; position: relative">
                            <div class="col-md-12">
                                ...
                                <form method="POST" action enctype="multipart/form-data"
                                    class="filter-form form-horizontal validation-form" id="validation-form">
                                                ...
                                                <div id="dados_formapagamento" class="tab-pane in active">
                                                    <div class="row">
                                                        <div class="form-group has-info">
                                                            <br /><br />
                                                            <label style="padding-top: 10px" class="
                                  col-sm-3
                                  control-label
                                  no-padding-right
                                  bold
                                " for="designacao">Designação<span class="tooltip-target" data-toggle="tooltip"
                                    ...
                                    "></i></b>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="input-group">
                                                                    <input type="text" v-model="formapagamento.designacao"
                                                                        placeholder="Informe a forma de pagamento"
                                                                        class="col-xs-12" :class="errors.designacao ? 'has-error' : ''
                                  ...
                                  no-padding-right
                                  bold
                                " for="password">Tipo Pagamento
                                                                <span class="tooltip-target" data-toggle="tooltip"
                                                                    data-placement="top"></span></label>
                                                            <div class="col-md-6">
                                                                <div class>
                                                                    <Select2 :options="tipoFormaPgt"
        ...
        <div class="modal fade" id="modalFechoCaixa" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
                ...
                <div class="modal-content" style="width: 460px">
                    ...
                    <div class="modal-body" style>
                        <form method="POST" class="form-horizontal validation-form" role="form">
                                    ...
                                    <div id="edit-basic" class="tab-pane in active">
                                        <div class="box box-primary">
                                            <div class="box-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <label for="dataFinal" class="control-label">Data Inicio</label>
                                                        <input type="datetime-local" autofocus class="form-control"
                                                            v-model="fechoCaixa.dataFecho"
                                                            :class="errors.dataFecho ? 'is-invalid' : ''" id="dataFinal" />
                                                ...
                                                <div class="row radio col-md-6">
                                                    <label>
                                                        <input name="form-field-radio1" v-model="fechoCaixa.tipoDoc"
                                                            :value="3" type="radio" class="ace input-sm" />
                                                        <span class="lbl bigger-100">Ticket</span>
                                                    </label>
                                                    <label>
                                                        <input name="form-field-radio2" v-model="fechoCaixa.tipoDoc"
                                                            :value="1" type="radio" class="ace input-sm" />
                            ...
                            <div class="clearfix form-actions">
                                <div class="col-md-9">
                                    <button class="btn btn-info" data-dismiss="modal" type="submit"
        ...
        <div class="modal fade" id="modalRelatorioMensal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content" style="width: 460px">
        ...
        <!-- MODAL FILTRAR MENSAL  -->
        <div class="modal fade" id="modalRelatorioPorFuncionarios" tabindex="-1" role="dialog"
                                ...
                                <div class="second-row">
                                    <div class="form-group has-info">
                                        <div class="col-md-12">
                                            ...
                                            <div class>
                                                <input type="text" v-model="produt.designacao" id="designacao"
                                                    class="col-md-12 col-xs-12 col-sm-4"
                                    ...
                                    <div class="form-group has-info">
                                        <div class="col-md-2">
                                            ...
                                            <div class>
                                                <input type="number" v-model="produt.quantidade_produto" id="designacao"
                                                    class="col-md-12 col-xs-12 col-sm-4"
                                                    :class="errors.designacao ? 'has-error' : ''" placeholder="0,00" />
                                                <!-- <span v-if="errors.designacao" class="error">{{errors.designacao[0]}}</span> -->
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            ...
                                            <div class>
                                                <input type="number" v-model="produt.preco_venda_produto" :min="0"
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class>
                                                <input type="number" :min="0" :max="100" v-model="produt.produto_desconto"
                                                    id="designacao" class="col-md-12 col-xs-12 col-sm-4"
                                                    :class="errors.designacao ? 'has-error' : ''" placeholder="0,00" />
                                                <!-- <span v-if="errors.designacao" class="error">{{errors.designacao[0]}}</span> -->
                                            </div>
                                        ...
                                        <div class="col-md-1">
                                            ...
                                            <div class>
                                                <input type="checkbox" v-model="produt.iva_produto" id="designacao"
                                                    class="col-md-12 col-xs-12 col-sm-4" />
                                                <!-- <span v-if="errors.designacao" class="error">{{errors.designacao[0]}}</span> -->
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                            <div class>
                                                ...
                                                <input type="checkbox" v-model="produt.produto_retencao"
                                                    class="col-md-12 col-xs-12 col-sm-4" />
                                                <!-- <span v-if="errors.designacao" class="error">{{errors.designacao[0]}}</span> -->
                                            </div>
                                        </div>
