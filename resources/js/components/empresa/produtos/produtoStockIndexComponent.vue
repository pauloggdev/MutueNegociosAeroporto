...
<!--                            </a>-->
                        ...
                        <div class="table-header widget-header">Todos estoques do Sistema (Total:{{queryExistencia.length}})</div>
                            ...
                            <table id="dynamic-table" class="tabela1 table table-striped table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr v-for="data in queryExistencia" :key="data.id">
                                        ...
                                        <td style="text-align:right">{{data.produtos.pvp | currency}}</td>
