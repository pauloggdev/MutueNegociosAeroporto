        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <form method="POST" enctype="multipart/form-data" class="filter-form form-horizontal validation-form"
                        id="validation-form">
                            ...
                            <div class="tabbable">
                                <div class="tab-content profile-edit-tab-content">
                                    <div id="dados_fornecedor" class="tab-pane in active" style="">
                                        ...
                                        <div class="form-group has-info bold" style="left: 0%; position: relative">
                                            <div class="col-md-9">
                                                <label class="control-label bold label-select2"
                                                    for="select_produto">Selecione o produto<b
                                                        class="red fa fa-question-circle"></b></label>
                                                <Select2 :options="produtosOptions" @select="changeProduto"
                                                    v-model="produto_id" id="produto_id" style="width: 100%"
                                                    placeholder="Escolha o produto por designação, codigo, codigo barra">
                                                </Select2>
                                                <span v-if="errors.produto_id" class="error">{{ errors.produto_id[0] }}</span>
                                            </div>
                                            <div class="col-md-3">
                                                <label class="control-label bold label-select2" for="spinner3">Quantidade à
                                                    transferir<b class="red fa fa-question-circle"></b></label>
                                                <div class="input-icon">
                                                    <vue-numeric-input v-model="quantidade_transferida" :min="0" :step="1"
                                                        id="quantidade_destino"
                                                        :class="errors.quantidade_destino ? 'has-error' : ''"></vue-numeric-input>
                                        ...
                                        <div class="form-group has-info bold" style="left: 0%; position: relative">
                                            <div class="col-md-9">
                                                <label class="control-label bold label-select2" for="select_armazem">Armazém
                                                    origem<b class="red fa fa-question-circle"></b></label>
                                                <Select2 :options="armazensOptions" @select="changeArmazemOrigem"
                                                    v-model="armazem_origem_id" id="armazem_origem" style="width: 100%"
                                                    placeholder="Escolha o armazem">
                                                </Select2>
                                            ...
                                            <div class="col-md-3">
                                                <label class="control-label bold label-select2"
                                                    for="designacao">Existência</label>
                                                <div class="input-group">
                                                    <input type="text" :value="quantidade_origem | formatQt"
                                                        :style="quantidade_origem == 0 ? 'border-color:red;color:red !important' : ''"
                                                        disabled id="" class="col-md-12 col-xs-12 col-sm-4" />
                                        ...
                                        <div class="form-group has-info bold" style="left: 0%; position: relative">
                                            <div class="col-md-9">
                                                <label class="control-label bold label-select2" for="select_armazem">Armazém
                                                    destino<b class="red fa fa-question-circle"></b></label>
                                                <Select2 :options="armazensOptions" @select="changeArmazemDestino"
                                                    v-model="armazem_destino_id" id="armazem_destino" style="width: 100%"
                                                    placeholder="Escolha o armazem">
                                                </Select2>
                                                <!-- <span v-if="errors.fornecedor_id" class="error">{{errors.fornecedor_id[0]}}</span> -->
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <label class="control-label bold label-select2"
                                                    for="designacao">Existência</label>
                                                <div class="input-group">
                                                    <input type="text" :value="quantidade_destino | formatQt"
                                                        :style="quantidade_destino == 0 ? 'border-color:red;color:red !important' : ''"
                                                        disabled id="" class="col-md-12 col-xs-12 col-sm-4" />
                                                    <span class="input-group-addon">
                                                        <i class="fa fa-info-circle bigger-110 text-info"></i>
                                                    </span>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="input-icon">
                                                    ...
                                                    <textarea type="text" style="height:50px"
                                                        v-model="transferenciaData.descricao" id="descricao"
                                                        class="col-md-12 col-xs-12 col-sm-4"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group has-info bold" style="left: 0%; position: relative">
                                        ...
                                        <div class="widget-box widget-color-green" style="left: 0%">
                                            ...
                                            <table class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    <tr v-for="(c, i) in transferenciaData.transferenciaProdutoItems"
                                                        :key="c.id">
                                                        <td>{{ c.produto_id }}</td>
                                                        ...
                                                        <td colspan="1">
                                                            <div class="hidden-sm hidden-xs action-buttons">
                                                                <a class="red" @click="delItemCar(i, c)"
                                                                    ...
                                                                    <i data-v-28b992ac=""
                                                                        class="ace-icon fa fa-trash-o fa-2x icon-only bigger-130">
                                                                    </i>
                                                                </a>
                                                            </div>
                                                        </td>
                                        ...
                                        <div class="clearfix form-actions">
                                            <div class="col-md-offset-3 col-md-9">
                                                <button class="search-btn" type="submit" style="border-radius: 10px"
                                                    @click.prevent="fazerTransferencia">
    ...
    methods: {
        ...
        async fazerTransferencia() {
            ...
            try {
                ...
                if (this.transferenciaData.transferenciaProdutoItems.length === 0) {
                    Swal.fire({
                        title: "Erro",
                        text: "É obrigatório adicionar os Items a Transferir",
                        icon: "error",
