  ...
  <div class="page-content">
    <div class="row">
      <div class="page-header">
        ...
        <h1>
          <small>
            <a href="opcao/centros/custo" style="color: #2679B5;font-size: 18px2;">Centros de Custo</a>
            <i class="ace-icon fa fa-angle-double-right"></i>
          </small>
          <span style="color: #2679B5;font-size: 14px;">
            Página Inicial
          </span>
          <small>
            <i class="ace-icon fa fa-angle-double-right"></i>
          ...
          <div class="col-md-7">
            ...
            <div class="infobox infobox-green2">
              ...
              <div class="infobox-data">
                ...
                <div class="infobox-content" style="color: black">Facturas Recibos</div>
              </div>
            </div>
