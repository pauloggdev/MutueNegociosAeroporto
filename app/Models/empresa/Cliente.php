...
class Cliente extends Model
{
    ...
    public function cartaoCliente(){
        return $this->belongsTo(CartaoCliente::class, 'clienteId', 'id');
    }
    public function cartoesCliente(){
        return $this->hasMany(CartaoCliente::class, 'clienteId', 'id');
    }
