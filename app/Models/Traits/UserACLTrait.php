...
trait UserACLTrait
{
    ...
    public function hasPermissionDashboard(string $permissionName): bool{
        return in_array($permissionName, $this->permissoes());
    }
    ...
    {
        $user = UserPerfil::where('perfil_id', 1)->where('user_id', auth()->user()->id)->first();
        return $user;
    }
}
