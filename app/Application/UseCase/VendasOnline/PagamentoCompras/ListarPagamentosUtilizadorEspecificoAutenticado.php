...
class ListarPagamentosUtilizadorEspecificoAutenticado
{
    ...
    public function execute($search){
        return $this->pagamentoVendasOnlineRepository->listarPagamentosUtilizadorEspecificoAutenticado($search);
    }
}
