...
class GerarSaftController extends Component
{
    ...
    public function gerarSaft($saft)
    {
        ...
        $header->appendChild($dom->createElement('SoftwareValidationNumber', '384/AGT/2022'));
        ...
        foreach ($facturas as $key => $factura) {
            ...
            foreach ($factura->facturas_items as $key => $Item) {
                ...
                $TaxCode = $Item->produto->tipoTaxa->taxa ? "NOR" : ($TaxType == "NS" ? "NS" : "NS");
        ...
        foreach ($facturas_proforma as $key => $facturaProforma) {
            ...
            foreach ($facturaProforma->facturas_items as $key => $ftProformaItem) {
                ...
                $TaxCode = $ftProformaItem->produto->tipoTaxa->taxa ? "NOR" : ($TaxType == "NS" ? "NS" : "NS");
