...
class ComunaFreteIndexController extends Component
{
    use LivewireAlert;
    public $search;
    public $municipioId;
    ...
    public function render(){
        ...
        $getComunasFrete = new GetComunasFrete(new DatabaseRepositoryFactory());
        $data['comunasFrete'] = $getComunasFrete->execute($this->search);
        return view('empresa.comunasFrete.index', $data);
    }
