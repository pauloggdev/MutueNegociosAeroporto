...
class ProdutoController extends Controller
{
    ...
    public function listarProdutosPorArmazem(Request $request){
        $getProdutos = new GetProdutosPorArmazem(new DatabaseRepositoryFactory());
        return $getProdutos->execute($request->search, $request->armazemId);
    }
    ...
    public function stock()
    {
        ...
        $data['produtoStock'] = ExistenciaStock::with(['produtos', 'armazens', 'status'])
