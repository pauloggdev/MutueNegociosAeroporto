...
class UserRepository
{
    ...
    public function createNewUser(array $data)
    {
        ...
        DB::connection('mysql')->table('user_perfil')
            ->insert([
                'user_id' => $user->id,
                'perfil_id' => $data['role_id']
            ]);
        return $user;
    }
    ...
    public function updateUser($data)
    {
        ...
        $user = DB::connection('mysql')->table('user_perfil')
    ...
    {
        $users = User::with(['statuGeral', 'perfis'])->when($byStatus, function ($query) use ($byStatus) {
